...
acs_2022_variables <- get_acs(
  geography = "tract",
  variables = c(estimate_of_children_under6 = "DP03_0014", estimate_of_children_over6 = "DP03_0016"), 
  state = "CA",
  county = "Orange",
  geometry = TRUE,
  output = "wide",
...
children_california_map <- ggplot(acs_2022_variables) +
  geom_sf_interactive(
    aes(
      fill = estimate_of_children_under6E | estimate_of_children_over6E, 
      tooltip = paste(NAME, ": ", estimate_of_children_under6E | estimate_of_children_over6E, "%"),
      data_id = NAME
    )
  ) +
  scale_fill_viridis_c(option = "magma") +
...
girafe(ggobj = children_california_map, width = 800, height = 800)
